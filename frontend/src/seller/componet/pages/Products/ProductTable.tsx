...
import { fetchSellerProducts } from 'src/State/seller/sellerProductSlice';
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell align="right">建議零售價</StyledTableCell>
                        <StyledTableCell align="right">售價</StyledTableCell>
                        <StyledTableCell align="right">顏色</StyledTableCell>
                        <StyledTableCell align="right">更新庫存</StyledTableCell>
